...
class SARemixInstaller(ctk.CTk):
    ...
    def create_main_page(self):
        ...
        # Add the new button for installing Remix 0.5.4
        self.install_remix_button = ctk.CTkButton(self.right_frame, text="Install Remix 0.5.4", 
                                                    command=self.Download_Remix_0_5_4, 
                                                    fg_color="transparent", border_width=1, 
                                                    border_color="#FFCC70", width=200, 
                                                    hover_color="#5c5c5a")
        self.install_remix_button.grid(row=6, column=0, pady=(5, 0))
    ...
    def Download_SARemix(self, event=None):
        def download_thread():
            ...
            # URLs for the split ZIP files
            base_url = "https://github.com/KCDQYaniss/GTASA-Remix/releases/download/test"
            zip_files = [
                {
                    "url": f"{base_url}/GTASA-Remix.z01",
                    "filename": "GTASA-Remix.z01"
                },
                {
                    "url": f"{base_url}/GTASA-Remix.z02",
                    "filename": "GTASA-Remix.z02"
                },
                {
                    "url": f"{base_url}/GTASA-Remix.z03",
                    "filename": "GTASA-Remix.z03"
                },
                {
                    "url": f"{base_url}/GTASA-Remix.zip",
                    "filename": "GTASA-Remix.zip"
                }
            ]
            ...
            try:
                ...
                try:
                    ...
                    main_zip = os.path.join(self.folder_selected, "GTASA-Remix.zip")
